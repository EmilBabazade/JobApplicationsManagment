# Microservice/Multi service project. I made this process only to play around with domain driven development, GRPC, Masstransit with RabbitMQ, MediatR and bunch of other stuff
...
It has Application as Model and aggregate root, it represents a job application and has references to one person and multiple documents. API has normal CRUD endpoints and 2 domain specific endpoints:
  ...
  Everything here is done with Mediatr, seperate commands for updating/creating/deleting and queries for gettign (TODO: finish this)
